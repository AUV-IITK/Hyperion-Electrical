...
(library Library_1
	...
	(patternDef "855075001" (originalName "855075001")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 4.445, -4.380) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.175 3.94) (pt 12.065 3.94) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 12.065 3.94) (pt 12.065 -12.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 12.065 -12.7) (pt -3.175 -12.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.175 -12.7) (pt -3.175 3.94) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "85507-5001" (originalName "85507-5001") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/85507-5001.pdf")
		(attr "<Component Height>" "16.4")
		(attr "<STEP Filename>" "85507-5001.stp")
	)
